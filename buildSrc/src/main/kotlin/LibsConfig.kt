...
fun Project.applyLibrariesConfiguration() {
    ...
    group = "${rootProject.group}.wgexperimentalflags-libs"
    ...
    tasks.register<ShadowJar>("jar") {
        ...
        relocate("com.sk89q.squirrelid", "de.terraconia.wgexperimentalflags.util.profile")
    }
    ...
    tasks.register<Jar>("sourcesJar") {
        ...
        eachFile {
            filter {
                it.replaceFirst(textPattern, "de.terraconia.wgexperimentalflags.util.profile")
            }
            path = path.replaceFirst(filePattern, "$1de/terraconia/wgexperimentalflags/util/profile$2")
        }
